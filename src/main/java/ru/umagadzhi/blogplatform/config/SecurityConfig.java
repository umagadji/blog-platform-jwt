package ru.umagadzhi.blogplatform.config;
...
import ru.umagadzhi.blogplatform.jwt.JwtAuthenticationFilter;
import ru.umagadzhi.blogplatform.services.UserService;
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:8080"));  // Разрешённые источники (фронтенд)
